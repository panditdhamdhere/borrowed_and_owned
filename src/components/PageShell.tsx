...
export function PageShell({ children }: PageShellProps) {
  return (
    <div className="min-h-full w-full bg-zinc-50 text-zinc-900 dark:bg-zinc-950 dark:text-zinc-100">
      <Header />
      <main className={`${SITE_CONTAINER_CLASS} py-12`}>{children}</main>
      <footer className="border-t border-zinc-200 py-8 dark:border-zinc-800/80">
        <div
          className={`${SITE_CONTAINER_CLASS} flex flex-col items-center gap-2 text-sm text-zinc-500 dark:text-zinc-600`}
        >
